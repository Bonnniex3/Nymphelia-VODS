...
const socials = [
  {
    path: `https://discord.gg/nymphelia`,
    icon: (
      <SvgIcon viewBox="0 0 71 55" className="text-primary" sx={{ color: '#f472b6' }}>
  ...
  {
    path: `https://www.twitch.tv/nymphelia`,
    icon: (
      <SvgIcon sx={{ color: '#f472b6' }}>
